<template>
    ...
    <div class="row p-4">
        ...
        <div class="col-12 sm:col-6 lg:col-7 lg:pl-10">
            ...
            <VariationComponent
                v-if="initialVariations.length > 0 && variationComponent"
                ...
                <dd class="flex items-center gap-6">
                    ...
                    >
                        <button
                            ...
                            type="button"
                            :class="
                                temp.quantity === 1 ? 'cursor-not-allowed' : ''
                            "
    ...
    methods: {
        ...
        show: function () {
            if (typeof this.$props.productId !== "undefined") {
                ...
                this.$store
                    .dispatch("posProduct/show", this.props.search)
                    .then((res) => {
                        this.initProduct = {
                            isVariation: false,
                            variationId: null,
                        ...
                        this.$store
                            .dispatch(
                                "posProductCategory/ancestorsAndSelf",
                        ...
                        this.$store
                            .dispatch(
                                "posProductVariation/initialVariation",
                                res.data.data.id
                            )
        ...
        addToCart: function () {
            ...
            if (this.selectedVariation) {
                this.$store
                    .dispatch(
                        "posProductVariation/ancestorsToString",
                    ...
                    .then((res) => {
                        ...
                        this.$store
                            .dispatch("posCart/lists", this.productArray)
                            .then((res) => {
