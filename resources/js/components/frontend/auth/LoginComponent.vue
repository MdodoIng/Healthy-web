<template>
    ...
    <div
        class="w-full max-w-3xl mx-auto rounded-2xl flex overflow-hidden gap-y-6 bg-white mb-24 !sm:mb-0 border-clr"
    >
        <img
        ...
        <form class="w-full p-6" @submit.prevent="login">
            ...
            <div :class="!toggleValue ? 'mb-6' : ''">
                <div class="flex items-center justify-between">
                    ...
                    <button
                        type="button"
                        class="text-sm font-medium capitalize mb-1 underline text-primary hidden"
                        @click="handleField()"
                    >
                        {{ inputButton }}
                    </button>
            ...
            <button
                type="submit"
                class="font-bold text-center w-full h-12 leading-12 radius-10 bg-primary text-black capitalize mb-6 txt-cap"
            >
                {{ $t("label.sign_in") }}
            </button>
