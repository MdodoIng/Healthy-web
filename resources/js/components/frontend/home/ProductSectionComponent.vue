        ...
        <section v-for="promotion in promotions" class="mb-10 sm:mb-20">
            <div class="container">
                <router-link :to="{name: 'frontend.promotion.products', params: { slug: promotion.slug }}" class="w-full">
                    <img class="w-full rounded-3xl mobile:min-h-[400px] object-cover" :src="promotion.preview" alt="promotion" loading="lazy">
                </router-link>
            </div>
        </section>
    </div>
