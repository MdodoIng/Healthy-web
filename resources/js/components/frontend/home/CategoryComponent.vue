            ...
            >
                ...
                >
                    <router-link
                        ...
                        class="w-full rounded-2xl shadow-xs group product_bxx"
                    >
                        <img
                        ...
                        />
                        <span
                            class="text-sm sm:text-xl font-medium capitalize text-center py-2 px-3 overflow-hidden text-ellipsis block rounded-bl-2xl rounded-br-2xl group-hover:text-primary product_nme"
                        >
                            {{ category.name }}
                        </span>
                    </router-link>
