<template>
    ...
    <form @submit.prevent="changePassword">
        <div class="p-6 mb-6 rounded-2xl shadow-card bg-white border border-[#D9DBE9]">
        ...
        <button type="submit"
            class="px-6 py-3 capitalize radius-10 whitespace-nowrap text-center font-semibold text-white bg-primary">save
            changes</button>
    </form>
</template>
