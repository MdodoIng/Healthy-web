                ...
                <div class="form-row">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        <div class="flex flex-wrap gap-6 mt-2"><button type="submit"
                                class="font-bold text-center h-12 leading-12 px-8 radius-10 whitespace-nowrap bg-primary text-white capitalize">{{
                                    $t('button.add_address')
                                }}</button><button @click="reset()" type="button"
                                class="font-bold text-center h-12 leading-12 px-8 radius-10 whitespace-nowrap bg-[#F7F7FC] capitalize">{{
                                    $t('button.cancel')
                                }}</button>
                        </div>
                    </div>
