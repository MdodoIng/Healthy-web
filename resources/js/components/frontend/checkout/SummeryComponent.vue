<template>
    <div class="bg-white rounded-2xl shadow-card border-clr">
        ...
        <div class="p-4">
            <dl class="flex items-center justify-between">
                <dt class="font-semibold capitalize total-txx">{{ $t('label.total') }}</dt>
                <dd class="font-semibold total-txx">{{ currencyFormat(total, setting.site_digit_after_decimal_point,
