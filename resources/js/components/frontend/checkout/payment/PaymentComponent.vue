<template>
    ...
    <div class="row">
        <div class="col-12 lg:col-8">
            <div class="mb-6 rounded-2xl shadow-card border-clr">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-5 gap-4 p-4">
                    <div v-if="Object.keys(cashOnDelivery).length > 0 && setting.site_cash_on_delivery === ActivityEnum.ENABLE"
                        ...
                        <img class="h-6" src="public/images/default/icon/wallet.svg" alt="payment" loading="lazy" />
            ...
            <div class="max-lg:hidden flex items-center justify-between gap-5 mt-10">
                ...
                <button @click.prevent="confirmOrder" class="field-button w-fit font-semibold tracking-wide normal-case bg-primary">
