<template>
    ...
    >
        <div class="container py-3.5 px-4 lg:py-0">
            <div class="header-top yellow-bg br_2">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <div
                                class="header_text text-md-left text-center"
                            ></div>
                        </div>
                        <div class="col-md-6">
                            <ul
                                class="header_list text-md-right text-center header_em"
                            >
                                <li class="text_w1">
                                    <img
                                        class="icon_hdr"
        ...
        <div class="container py-[18px] px-4">
            <div class="flex items-center justify-between gap-5">
                ...
                <form
                    ...
                    class="hidden w-full lg:w-80 h-10 search-box lg:flex items-center gap-2 px-4 border transition-all duration-300 focus-within:border-primary focus-within:bg-white frm_l"
                >
                    <button
                ...
                >
                    ...
                    <span
                        ...
                        class="absolute top-9 ltr:-right-9 rtl:-left-2 text-[10px] font-medium h-4 pxx-1 !leading-[14px] text-center rounded-full text-white bg-green border"
                    >
                        {{ wishlists.length }}
                    </span>
                </router-link>
                ...
                <div class="relative hidden lg:block group">
                    ...
                    >
                        ...
                        <nav class="flex flex-col py-2">
                            ...
                            >
                                <img
                                    class="account-icn group-hover:text-primary transition-all duration-500"
                                    src="public/images/default/icon/invite-alt.svg"
                                />
                                <span
                                    class="text-sm font-medium capitalize whitespace-nowrap"
                                >
                            ...
                            >
                                <img
                                    class="account-icn group-hover:text-primary transition-all duration-500"
                                    src="public/images/default/icon/undo.svg"
                                />
                                <span
                                    class="text-sm font-medium capitalize whitespace-nowrap"
                                >
                            ...
                            >
                                <img
                                    class="account-icn group-hover:text-primary transition-all duration-500"
                                    src="public/images/default/icon/circle-user.svg"
                                />
                                <span
                                    class="text-sm font-medium capitalize whitespace-nowrap"
                                >
                            ...
                            >
                                <img
                                    class="account-icn group-hover:text-primary transition-all duration-500"
                                    src="public/images/default/icon/password.svg"
                                />
                                <span
                                    class="text-sm font-medium capitalize whitespace-nowrap"
                                >
                            ...
                            >
                                <img
                                    class="account-icn group-hover:text-primary transition-all duration-500"
                                    src="public/images/default/icon/address-book.svg"
                                />
                                <span
                                    class="text-sm font-medium capitalize whitespace-nowrap"
                                >
                    ...
                    >
                        <router-link
                            class="!text-primary !bg-[#FFF4F1] w-full text-center h-12 leading-12 font-semibold tracking-wide radius-10 whitespace-nowrap"
                            :to="{ name: 'auth.signup' }"
                        >
                        ...
                        >
                        <router-link
                            class="w-full text-center h-12 leading-12 font-semibold tracking-wide radius-10 whitespace-nowrap text-black bg-primary"
                            :to="{ name: 'auth.login' }"
                        >
                ...
                >
                    ...
                    />
                    <span>
                        <h6 class="hd_txt">Cart</h6>
                    </span>
                    <span
                        v-if="carts.length > 0"
                        class="w-4 absolute top-04 ltr:right-2 rtl:left-1 text-[10px] font-medium h-4 px-1 leading-[14px] text-center rounded-full border text-white bg-green"
                    >
                        {{ carts.length }}
                    </span>
                </button>
        ...
        <div class="container py-3.5 px-4 lg:py-0 hidden lg:block">
            ...
            <nav class="header-nav hidden lg:block py-2">
                <ul class="header-nav-list">
                                ...
                                >
                                    ...
                                    >
                                        <router-link
                                            ...
                                            "
                                            class="capitalize text-[.965rem] font-medium tracking-wide px-5 py-4 transition-all duration-300 relative before:content-[''] before:absolute before:bottom-0 before:left-0 before:h-0.5 before:bg-primary hover:text-primary"
                                            :class="{
                                    ...
                                    <div v-for="category in categories">
                                        ...
                                        >
                                            <div
                                                class="w-full h-80 thin-scrolling pt-6 pl-6"
                                            >
                                                <div
                                                    class="w-full grid gap-3 grid-cols-3"
                                                >
                                                    <div
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <router-link
                                                                ...
                                                                class="hover:text-black transition-all duration-300 inline-flex items-center"
                                                            >
                                            ...
                                            <div
                                                class="w-60 h-80 flex-shrink-0 pt-6 pr-6"
                                            >
                                                <img
                    ...
                    <li class="header-nav-item">
                        <router-link
                            class="header-nav-menu btm_menu"
                            :class="
