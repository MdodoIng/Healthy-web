<template>
    ...
    <footer class="pt-12 bg-clr mobile:hidden">
            ...
            <div class="row">
                <div class="col-12 md:col-4 lg:col-3 mb-6 md:mb-0">
                    <div class="tablet:text-center tablet:mx-auto w-full max-w-xs">
                        <router-link :to="{ name: 'frontend.home' }">
                            <img class="mb-5 w-13 lgo_top" :src="setting.theme_footer_logo" alt="logo" loading="lazy">
                        </router-link>
                         <div class="fb-iner">
                            <div class="footer-social ftr-ml">
                                <ul>
                                    <li><a href="#"><img class="icon_ftr" src="public/images/default/icon/facebook.svg"></a></li>
                                    <li><a href="#"><img class="icon_ftr" src="public/images/default/icon/instagram.svg"></a></li>
                ...
                <div class="col-12 md:col-8 lg:col-8">
                    ...
                    <div class="col-12 sm:col-4">
                            <h4 class="text-[22px] font-semibold capitalize mb-6 text-black ftr-titl">
                                {{ $t('label.contact') }}</h4>
                            <ul class="flex flex-col gap5 pt-5">
                                <li class="flex gap-3">
                                    <img class="icon_smedia" src="public/images/default/icon/marker.svg">
                                    <span class="adds_tx font-medium text-black">{{ setting.company_address }}</span>
                                </li>
                                <li class="flex gap-3">
                                    <!--<i class="lab-fill-mail text-sm flex-shrink-0 text-white"></i>-->
                                     <img class="icon_smedia" src="public/images/default/icon/envelope-dot.svg">
                                    <span class="text-ftr font-medium text-black">{{ setting.company_email }}</span>
                                </li>
                                <li class="flex gap-3">
                                    <img class="icon_smedia" src="public/images/default/icon/square-phone-hangup.svg">
                                    <span class="text-ftr font-medium text-black">{{ setting.company_phone }}</span>
                                </li>
                            </ul>
                        ...
                        <div class="col-6 sm:col-4 mb-4 sm:mb-0">
                            <h4 class="text-[22px] font-semibold capitalize mb-6 text-black ftr-titl">{{ $t('label.support') }}</h4>
                            <nav v-if="supportPages.length > 0" class="flex flex-col gap-4 pt-5">
                        ...
                        <div class="col-6 sm:col-4 mb-4 sm:mb-0">
                            <h4 class="text-[22px] font-semibold capitalize mb-6 text-black ftr-titl">{{ $t('label.legal') }}</h4>
                            <nav v-if="legalPages.length > 0" class="flex flex-col gap-4 pt-5">
                            ...
                            <form @submit.prevent="saveSubscription" class="mt-5 mb-6 block subbr">
                            <label class="mb-3 mt-5 font-medium text-black">
                                {{ $t('message.subscribe_to_our_newsletter') }}
                            </label>
                            <div class="flex w-full h-10 radius-10 p-1 bg-white mt-3">
        ...
        <div class="pt-4 pb-24 lg:py-4 mt-8 text-center copy_bg">
            <p class="footer-xs font-medium text-white">{{ setting.site_copyright }}</p>
        </div>
    </footer>
</template>
