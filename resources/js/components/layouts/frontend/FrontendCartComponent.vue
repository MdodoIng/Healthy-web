<template>
    <aside id="cart-canvas" class="fixed inset-0 z-30 bg-black/50 duration-500 transition-all invisible opacity-0">
        <div class="w-full radius-10 max-w-md hg-screen overflow-x-hidden overflow-y-auto bg-white duration-500 transition-all ms-auto ltr:translate-x-full rtl:-translate-x-full margin-lr">
            ...
            <ul v-if="carts.length > 0" class="p-4 h-[calc(100vh_-_385px)] overflow-y-auto">
                <li v-for="(cart, index) in carts"
                    ...
                    <div class="relative w-full overflow-hidden">
                        ...
                        <div class="flex items-start justify-between gap-3">
                            ...
                            <button @click.prevent="removeProduct(index)" class="flex items-center gap-1.5 px-2.5 py-1 radius-10 bg-[#FFF4F4] text-[#E93C3C] transition-all duration-300 hover:bg-[#E93C3C] hover:text-white">
